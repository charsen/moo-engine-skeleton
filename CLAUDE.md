...
全部九章搭好并真机验证（第 8 章为部署指引，代码产物即根目录的 `.github/workflows/tests.yml`；
第 9 章为增量开发演练，有代码产物）；从 0 开始的过程写在 `docs/`
...
全量测试 41 个（AuthTest/FoodAclTest/ApiAuthTest 三件套 + JwtAutoRefresh/SeederIntegrity/Regression 守护测试 + FoodIncremental/ApiFood + 示例），
