...
全部八章搭好并真机验证（第 8 章为部署指引，无代码产物）；从 0 开始的过程写在 `docs/`
（`docs/README.md` 是目录，含一张 22 条「踩过的坑」速查表；`docs/index.html`
...
全量测试 35 个（AuthTest/FoodAclTest/ApiAuthTest 三件套 + JwtAutoRefresh/SeederIntegrity/Regression 守护测试 + 示例），
